...
app.put("/posts/:postId/like", authenticateToken, async (req, res) => {
  ...
  console.log(postId)
  const userId = req.userId; // Assuming you have a way to get the logged-in user's ID
  const authHeader = req.headers['authorization'];
  ...
  try {
    ...
    const updatedPost = await Post.findByIdAndUpdate(
      postId,
      { $addToSet: { likes: token } }, // Add user's ID to the likes array
...
app.put("/posts/:postId/unlike", authenticateToken, async (req, res) => {
  const postId = req.params.postId;
