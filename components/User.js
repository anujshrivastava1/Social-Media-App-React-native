// It uses useEffect to reset the requestSent state whenever userId or item prop changes.
//  It uses useState to manage the state of requestSent, which indicates whether a follow request has been sent
